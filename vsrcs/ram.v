module ram(
  ...
  always@(*)begin
	if(readen_in)
	  ramdata_out = ram_reg[ramaddr_in[19: 2]];
	else
	  ramdata_out = 32'b0;
  end
  ...
  always@(posedge clk)begin
	if(bt0en_in)
	  ram_reg[ramaddr_in[19: 2]][7: 0] <= ramdata_in[7: 0];
	if(bt1en_in)
	  ram_reg[ramaddr_in[19: 2]][15: 8] <= ramdata_in[15: 8];
	if(bt2en_in)
	  ram_reg[ramaddr_in[19: 2]][23: 16] <= ramdata_in[23: 16];
	if(bt3en_in)
